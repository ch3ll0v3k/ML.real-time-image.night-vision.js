...
(async ()=>{
  ...
  const dataset = await createSubsetInputData( `./data-cars-light/cartoon`, '.y.jpg', SUBSET );
  ...
  const dataset_name = `./dataset.${W}x${H}.SUBSET.${SUBSET}.cartoon.json`;
  console.log({dataset_name})
  console.jsonToFile( dataset_name, dataset, true, 2, true );
  // dataset.512x512.SUBSET.30.cartoon.json
